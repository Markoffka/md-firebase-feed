    ...
    <>
        ...
        <div>
          <div className="status-container mt-28 complete">
            ...
            <div className="status-container-inner">
              ...
              <h4 className="title-h4 white status-title mt-12">
                <span className="num-symbol">№</span> <span className="unrz">{GetUNRZ()}</span>
              </h4>
            </div>
          </div>
          ...
          <div className="person-data person-data-attrs mt-24">
            ...
            <div className="mb-4 person-data-wrap attr-wrap">
              ...
              <div className="attrValue small-text gray">{GetPass()}</div>
            </div>
            <div className="mb-4 person-data-wrap attr-wrap">
              <div className="small-text mb-4 mr-4 attr-title">Дата рождения: </div>
              <div className="attrValue small-text gray">{GetDayBirth()}</div>
            </div>
          </div>
      ...
      <style jsx>{`
        ...
        * {
        ...
        .status-container.complete .normal-image,
        .status-container.invalid .normal-image {
          display: none;
        }
        .title-h4 {
          font-size: 20px;
        ...
        .lang-image.en .lang-en,
        .lang-image.ru .lang-ru {
          display: block;
        }
